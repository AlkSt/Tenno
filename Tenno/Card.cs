...
namespace Tenno
{
    ...
    public class Card : ICloneable
    {
        ...
        public Card()
        {
            //надо ли сюда что нить сунуть?
        }
        
        public Card(int power, string im, string bim)// сила карты и наличие специальой способности путь к картинке
        {
            SpecialAbility = Abilitys.NaN;
            Power = power;
            Shield = power;
          //  if (power == 4) { Shield = power; Power = 8; }
